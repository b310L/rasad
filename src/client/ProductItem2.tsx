...
const ProductItem = ({title,desc,date,weight,degree,atMostPrice,salePrice,imageSrc}:any) => {
      ...
      >
        <Box display={"flex"} alignItems={"center"} gap={1} overflow={"clip"}>
         ...
         {title}
            ...
            >
              {desc} های تازه و خوشمزه از بهترین باغهای ایران
          ...
          <Box
            ...
            overflow={"hidden"}
          >
            <Image src={'http://0.0.0.0:8088/'+imageSrc} fill alt={name} />
          </Box>
        </Box>
        <Divider />
        {/* date */}
